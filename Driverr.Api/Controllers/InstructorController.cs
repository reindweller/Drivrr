    ...
    public class InstructorController : Controller
    {
        ...
        public IEnumerable<InstructorViewModel> GetAll()
        {
            ...
            return _context.Instructors.Select(o => new InstructorViewModel
            {
                ...
                StateId = o.StateId,
                State = o.State.Name,
                SuburbId = o.SuburbId == null ? Guid.Empty : o.SuburbId.Value,
                Suburb = o.Suburb.Name,
                PostCode = o.Suburb.PostCode,
                Address = o.Address,
                School = o.School,
                Email = o.Email,
                Phone = o.Phone,
        ...
        public IActionResult Update(Guid id, [FromBody] InstructorViewModel item)
        {
            ...
            instructor.StateId = item.StateId;
            instructor.SuburbId = item.SuburbId;
